...
@Component({
  ...
  imports: [CommonModule, ReactiveFormsModule], // Importa los módulos necesarios para el componente
...
export class HomeComponent {
  ...
  changeHandler() {
    if (this.newTaskCtrl.valid) { // Verifica si el formulario es válido
